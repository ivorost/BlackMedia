...
public class VideoSetupViewerACK : VideoSetupSlave {
...
public class VideoSetupSenderACK : VideoSetupSenderQuality {
    private let timebase: Timebase
    private let metric: StringProcessor.Proto

    public init(root: VideoSetupProtocol, timebase: Timebase, metric: StringProcessor.Proto = StringProcessor.shared) {
        self.timebase = timebase
        self.metric = metric
