...
//  CaptureIOS Upload ExtensionSetupUI
//
...
@objc class BroadcastSetupViewController: UIViewController {

    override func viewDidLoad() {
    }
    
    @IBAction @objc func buttonAction(_ sender: Any) {
        userDidFinishSetup()
    }
    ...
    func userDidFinishSetup() {
        ...
        let broadcastURL = URL(string:"ws://relay.raghava.io")
