...
extension Video.Setup {
    open class Vector : BlackMedia.Capture.Setup.VectorBase<Proto>, Proto {
        public func video(_ video: Video.Processor.AnyProto, kind: Video.Processor.Kind) -> Video.Processor.AnyProto {
...
fileprivate extension Video.Setup {
    class CaptureAdapter : SessionAdapter {
        private let capture: BlackMedia.Capture.Setup.Proto
        
        init(_ capture: BlackMedia.Capture.Setup.Proto) {
